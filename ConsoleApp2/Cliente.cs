...
░╚════╝░╚══════╝╚═╝╚══════╝╚═╝░░╚══╝░░░╚═╝░░░╚══════╝╚═════╝░");
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Erro: O número deve ter exatamente 11 caracteres.");
                Console.ResetColor();
            ...
            foreach (var cliente in litsaP) // Usa a lista criada acima
            {
    ...
    // Modelo da classe ProdutoCad (caso ainda não exista)
    internal class ProdutoCadd
    {
        ...
        {
            return $"Produto: {NomeProduto}, Preço: {Preco:C}";
        }
    }
}

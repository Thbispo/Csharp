...
namespace Exercitando_1
{
    public class Program
    {
        static void ExibirCabecalho()
        {
            ...
            Console.WriteLine("Thiago Bispo Souza");
            Console.WriteLine(@"
...
╚══════╝╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝░╚════╝░╚═╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚══╝╚═════╝░░╚════╝░");
        ...
        static void opcoesMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("7. Verificar se pode votar e dirigir");
        ...
        static void VerificarVotoEDirigir()
        {
            Console.Clear();
            ...
            if (idade >= 18)
            {
                Console.WriteLine($"{nome}, você pode votar e dirigir.");
            }
            else
            {
                Console.WriteLine($"{nome}, você ainda não pode votar nem dirigir.");
            }
        }
    }
}
